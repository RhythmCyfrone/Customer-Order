    ...
    <div className='w-full flex flex-col gap-y-[4px]'>
        ...
        <div className='ps-[16px] pe-[16px] pt-[8px] flex items-center'>
            <div className='flex w-[40%] flex-col'>
                <span className='font-poppins font-medium text-[16px] leading-[24px]'>Water Bottle</span>
            ...
            <div className='flex w-[25%] gap-x-[16px]'>
                ...
                <div className='flex-1 text-center'> 
                    <span className='font-poppins font-medium text-[16px] leading-[24px]'>1</span>
                </div>
        ...
        <div className='ps-[16px] pe-[16px] pt-[8px] flex items-center'>
            <div className='flex w-[40%] flex-col'>
                <span className='font-poppins font-medium text-[16px] leading-[24px]'>Veg Salads</span>
                <span className='font-poppins font-normal text-[10px] leading-[15px]'>(Single)</span>
            </div>
            <div className='flex w-[25%] gap-x-[16px]'>
                <img src={DeleteItemCountIcon} className='cursor-pointer'/>
                <div className='flex-1 text-center'> 
                    <span className='font-poppins font-medium text-[16px] leading-[24px]'>10</span>
                </div>
                <img src={AddItemCountIcon} className='cursor-pointer'/>
            </div>
            <div className='flex w-[25%] flex-col items-center gap-y-[2px]'>
            ...
            <div className='w-[15%] text-right'> 
                <span className='font-poppins font-medium text-[20px] leading-[24px]'>199/-</span>
            </div>
        </div>
    </div>
  )
